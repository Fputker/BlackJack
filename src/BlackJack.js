...
let suits = ['Hearts', 'Spades', 'Diamonds', 'Clubs'],
    values = ['1', 'King', 'Queen', 'Jack', '10', '9', '8', '7', '6', '5', '4', '3', '2'];

// Button variables
let dealertext = document.getElementById('dealer-text-area'),
    playertext = document.getElementById('player-text-area'),
    playertext2 = document.getElementById('player-text-area-2'),
    ...
    cardDeckObject = document.getElementById('svgCards');
